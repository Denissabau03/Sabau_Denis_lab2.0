...
namespace Sabau_Denis_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Sabau_Denis_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Sabau_Denis_lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
